...
import (
	controllerv1beta1 "github.com/masudur-rahman/crdController/pkg/client/clientset/versioned/typed/controller.crd/v1beta1"
...
type Interface interface {
	...
	Controller() controllerv1beta1.ControllerV1beta1Interface
}
...
func (c *Clientset) Controller() controllerv1beta1.ControllerV1beta1Interface {
	return c.controllerV1beta1
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.controllerV1beta1, err = controllerv1beta1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.controllerV1beta1 = controllerv1beta1.NewForConfigOrDie(c)
