...
type FooInterface interface {
	Create(*v1beta1.Foo) (*v1beta1.Foo, error)
	Update(*v1beta1.Foo) (*v1beta1.Foo, error)
	UpdateStatus(*v1beta1.Foo) (*v1beta1.Foo, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.Foo, error)
	List(opts v1.ListOptions) (*v1beta1.FooList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Foo, err error)
	FooExpansion
}
...
func newFoos(c *ControllerV1beta1Client, namespace string) *foos {
	return &foos{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *foos) Get(name string, options v1.GetOptions) (result *v1beta1.Foo, err error) {
	result = &v1beta1.Foo{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) List(opts v1.ListOptions) (result *v1beta1.FooList, err error) {
...
func (c *foos) Create(foo *v1beta1.Foo) (result *v1beta1.Foo, err error) {
	result = &v1beta1.Foo{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Update(foo *v1beta1.Foo) (result *v1beta1.Foo, err error) {
	result = &v1beta1.Foo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) UpdateStatus(foo *v1beta1.Foo) (result *v1beta1.Foo, err error) {
	result = &v1beta1.Foo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Foo, err error) {
	result = &v1beta1.Foo{}
